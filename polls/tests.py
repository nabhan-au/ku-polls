...
class QuestionModelTests(TestCase):
    """This class contain test case for question module."""
    ...
    def test_was_published_recently_with_old_question(self):
        """was_published() returns False for questions whose pub_date is older than 1 day."""
    ...
    def test_is_published_recently_with_future_question(self):
        """is_published() returns False for questions whose pub_date is with in the future."""
        time = timezone.now() + datetime.timedelta(days=30)
        future_question = Question(pub_date=time)
        self.assertFalse(future_question.is_published())

    def test_is_published_recently_with_closed_question(self):
        """is_published() returns True for questions that already closed."""
    ...
    def test_can_vote_with_future_question(self):
        """can_vote() returns False for questions whose pub_date is with in the future."""
...
def create_question(question_text, days):
    ...
    return Question.objects.create(
        ...
        end_date=timezone.now() + datetime.timedelta(30)
    )


class QuestionIndexViewTests(TestCase):
    """This class contain test of question index views."""
    ...
    def test_future_question_and_past_question(self):
        """Even if both pas and future questions exists, only past questions are displayed."""
        question = create_question(question_text="Past question.", days=-30)
        create_question(question_text="Future question.", days=30)
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(
...
class QuestionDetailViewTests(TestCase):
    """This class contains test case in detail page."""

    def test_future_question(self):
        """The detail views of question with pub_date in the future returns a 404 not found."""
    ...
    def test_past_question(self):
        """The detail views of a question with pub_date in the past displays the question's text."""
