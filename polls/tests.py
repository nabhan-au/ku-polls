...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        """
        was_published() returns False for questions whose pub_date
        is older than 1 day.
        """
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question_and_past_question(self):
        """
        Even if both pas and future questions exists, only past questions
        are displayed.
        """
        question = create_question(question_text="Past question.", days=-30)
        create_question(question_text="Future question.", days=30)
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        """
        The detail views of question with pub_date in the future
    ...
    def test_past_question(self):
        """
        The detail views of a question with pub_date in the past
